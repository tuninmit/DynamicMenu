...
onelinkDynamicItems.Push(ItemMenu.parseFromString('Q|10.15.199.17|Send###tail -1000f /opt/one/logs/webapp.log'))
onelinkDynamicItems.Push(ItemMenu.parseFromString('A|10.15.199.17|Send###tail -1000f /opt/one/logs/apigw.log'))
onelinkDynamicItems.Push(ItemMenu.parseFromString('Z|10.15.199.17|Send###tail -1000f /opt/one/logs/authen.log'))
