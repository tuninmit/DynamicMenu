...
qoeDynamicItems.Push(ItemMenu.parseFromString('A|10.15.13.162|Send###tail -1000f /opt/one/logs/wifiqoe-api.log'))
qoeDynamicItems.Push(ItemMenu.parseFromString('Z|10.15.13.162|Send###tail -1000f /opt/one/logs/wifiqoe-http.log'))

qoeDynamicItems.Push(ItemMenu.parseFromString('restart|10.15.13.162|', false, true))
qoeDynamicItems.Push(ItemMenu.parseFromString('W|10.15.13.162|Send###systemctl restart wifiqoe-webapp.service'))
qoeDynamicItems.Push(ItemMenu.parseFromString('S|10.15.13.162|Send###systemctl restart wifiqoe-api.service'))
qoeDynamicItems.Push(ItemMenu.parseFromString('X|10.15.13.162|Send###systemctl restart wifiqoe-http.service'))
